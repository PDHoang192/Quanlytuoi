...
# ==========================================
# 1. CẤU HÌNH TRANG VÀ CSS GIAO DIỆN
# ==========================================
...
# ==========================================
# 4. CHẠY LOGIC & HIỂN THỊ NỘI DUNG CHÍNH
# ==========================================
if uploaded_file:
    ...
    if not df_raw.is_empty():
        ...
        with st.sidebar:
            ...
            date_mode = st.radio("Phạm vi:", ["Toàn bộ", "Tùy chọn"])
            start_date, end_date = min_d, max_d
            if date_mode == "Tùy chọn":
                sel_dates = st.date_input("Chọn ngày:", [min_d, max_d], min_value=min_d, max_value=max_d)
                        ...
                        with st.container(border=True):
                            ...
                            if cols:
                                ...
                                if not df_clean.is_empty():
                                    ...
                                    st.plotly_chart(px.bar(df_p3, x="Date", y=p_map[cols[0]], color='Giai đoạn'), use_container_width=True)

                                    st.divider()
                                    sel_g = st.selectbox("Xem chi tiết Giai đoạn:", [s["Giai đoạn"] for s in stgs])
    ...
    st.info("Vui lòng tải lên file dữ liệu ở thanh điều hướng bên trái.")
